...
const getIconForService = (title: string, index: number) => {
  ...
  if (t.includes("sitio") || t.includes("web") || t.includes("landing"))
    return FaLaptopCode;
...
export default function ScrollCarousel({
  ...
  ariaLabel = "Servicios",
  contactHref = "/contact",
  contactLabel = "Agendar diagnóstico",
}: ScrollCarouselProps) {
  ...
  return (
    ...
    >
      ...
      <div className="sticky top-0 h-screen w-full flex flex-col justify-center overflow-hidden bg-canvas">
        ...
        <div className="hidden md:absolute top-[10vh] left-1/2 -translate-x-1/2 z-10 md:flex items-center gap-2">
          {items.map((_, i) => (
            <motion.div
              key={i}
              initial={false}
